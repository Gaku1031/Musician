package com.example.musician.filter;
...
@Configuration
public class FromAuthenticationProviderArtist implements AuthenticationProvider {

    protected static Logger log = LoggerFactory.getLogger(FromAuthenticationProviderArtist.class);
    ...
    public Authentication authenticate(Authentication auth) throws AuthenticationException {
        ...
        Artist entity = repository.findByArtistname(name);
        if (entity == null) {
