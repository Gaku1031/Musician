...
import com.example.musician.filter.FromAuthenticationProviderArtist;
import com.example.musician.repository.ArtistRepository;

@Configuration
public class SecurityConfigArtist extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    private FromAuthenticationProviderArtist authenticationProviderArtist;
    ...
    */
    ...
    protected void configure(HttpSecurity http) throws Exception {
        // @formatter:off
        http.authorizeRequests().antMatchers("/login", "/logout-complete", "/artists/new", "/artist").permitAll()
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth.authenticationProvider(authenticationProviderArtist);
    }
